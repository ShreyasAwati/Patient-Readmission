...
Loading the data
```{r}
raw.data <- read.csv("file:///C:/Users/Shreyas/Documents/diabetes.csv",sep = ",", header = T, na.strings = "?")
head(raw.data)
summary(raw.data)
```
...
pat_knn <- train(readmitted ~ ., data = train, method = "knn", trControl = control_knn, tuneLength = 20)
stopCluster(clus)
